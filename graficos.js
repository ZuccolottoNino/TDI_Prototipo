...
/* CORREGIDO — fuente: baxbench.com y el paper "BaxBench: Can LLMs Generate
   Correct and Secure Backends?" (uno de los 11 links del TP). El propio sitio
   y el paper afirman textualmente que NINGÚN modelo supera el 37% de
   generación correcta-y-segura, y que ~40% de los programas fallan la prueba
   funcional (quedan "incorrectos"). Eso fija el techo real: seguro ≤ 37%.
   La tabla del leaderboard con el desglose EXACTO por modelo (Claude 4.5,
   Gemini 3 Pro, etc.) se carga con JavaScript en baxbench.com y no pudo
   confirmarse de forma remota — REVISAR A MANO en baxbench.com antes de
   entregar y ajustar estos 5 valores si difieren. El orden de magnitud y el
   techo del 37% sí están confirmados por el paper.
   Para AutoBaxBuilder/AutoBaxBench (arXiv 2512.21132, linkeado desde la
   propia baxbench.com) no hay tabla pública por modelo; el paper solo dice
   que "la tendencia y el desempeño general... es similar al desempeño en
   los tests de BaxBench", por eso se usan acá los mismos valores que BaxBench
   como aproximación explícita, no como dato medido de forma independiente. */
const DATOS_GRAFICO_BARRAS = [
  {
    nombre: "Claude 4.5",
    serieA: { seguro: 37, inseguro: 23 }, // Total correcto = 60% / Incorrecto = 40%
    serieB: { seguro: 37, inseguro: 23 }  // techo real del benchmark (paper BaxBench)
  },
  {
    nombre: "Gemini 3 Pro",
    serieA: { seguro: 34, inseguro: 21 }, // Total correcto = 55%
    serieB: { seguro: 34, inseguro: 21 }
  },
  {
    nombre: "Claude 3.7",
    serieA: { seguro: 30, inseguro: 20 }, // Total correcto = 50%
    serieB: { seguro: 30, inseguro: 20 }
  },
  {
    nombre: "Gemini 2.5",
    serieA: { seguro: 26, inseguro: 18 }, // Total correcto = 44%
    serieB: { seguro: 26, inseguro: 18 }
  },
  {
    nombre: "Grok 4",
    serieA: { seguro: 24, inseguro: 17 }, // Total correcto = 41%
    serieB: { seguro: 24, inseguro: 17 }
  }
];
...
const NOMBRE_GRAFICO_TIEMPO = "Nivel de adopción de código generado por IA (2026)";
const ESCALA_MAX_TIEMPO = 10;
const HITOS_GRAFICO_TIEMPO = [
  {
    anio: "CUARTIL INFERIOR",
    numero: "01",
    valor: 1,
    porcentaje: "<10%",
    fase: "FASE 01 // ADOPCIÓN MÍNIMA",
    metrica: "<10% del código es generado por IA · organizaciones de adopción baja",
    detalle: "Según el benchmark 2026 de Larridin (\"Developer Productivity Benchmarks 2026\"), las organizaciones del cuartil inferior tienen menos del 10% de sus líneas de código escritas con asistencia de IA. La herramienta está disponible pero se usa de forma marginal, sin integrarse todavía al flujo de trabajo diario."
  },
  {
    anio: "PROMEDIO DE LA INDUSTRIA",
    numero: "02",
    valor: 2,
    porcentaje: "15%–25%",
    fase: "FASE 02 // ADOPCIÓN ESTÁNDAR",
    metrica: "15%–25% del código es generado por IA · promedio de la industria en 2026",
    detalle: "El mismo benchmark de Larridin ubica el promedio de la industria en 2026 entre 15% y 25% de código asistido por IA. Google, según reporta gloss.run, está cerca de este nivel: 25% de su código nuevo es escrito por IA."
  },
  {
    anio: "CUARTIL SUPERIOR",
    numero: "03",
    valor: 5,
    porcentaje: "40%–60%",
    fase: "FASE 03 // ADOPCIÓN ALTA",
    metrica: "40%–60% del código es generado por IA · equipos de adopción alta",
    detalle: "Las organizaciones del cuartil superior (Larridin, 2026) llegan a 40%–60% de código asistido por IA. GitHub y Netcorp Software Development ubican acá el estado actual \"promedio\" del sector en sentido amplio: GitHub reporta 51% de código commiteado a inicios de 2026 generado o asistido por IA (gloss.run), y Netcorp habla de que \"casi la mitad de todo el código es hoy generado por IA\"."
  },
  {
    anio: "EQUIPOS DE ÉLITE",
    numero: "04",
    valor: 8,
    porcentaje: ">75%",
    fase: "FASE 04 // ADOPCIÓN DE ÉLITE",
    metrica: ">75% del código es generado por IA · equipos de élite (2026) · proyección >50% de todo el código nuevo para 2028",
    detalle: "En el extremo superior, Larridin ubica a los equipos de élite por encima del 75% de código asistido por IA — y Snap, según gloss.run, ya está en 65%, cerca de ese nivel. Larridin también cita un consenso de la industria que proyecta que más del 50% de TODO el código nuevo (no solo en organizaciones de punta) será generado por IA para 2028."
  }
];
